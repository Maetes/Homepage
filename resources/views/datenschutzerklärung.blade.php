...
@section('content')
    ...
    <div class="mx-auto px-10 lg:px-32 py-10 font-basic">
        <h1 class="text-2xl font-semibold font-title pb-3">Datenschutzerklärung</h1>
        {{--  Datenschutz Content --}}
        <p>Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO), ist:</p>
        <p>MTW IT-Solutions UG (haftungsbeschränkt)
            <br>
            <br>Geschäftsführer
            <br>
            <br>Tomczak, Tim
            ...
            <br>Am Spargelfeld 9
            <br>53797 Lohmar</p>
        <h2 class="font-basic text-xl font-semibold py-2">Ihre Betroffenenrechte</h2>
        ...
        <p></p><h2 class="font-basic text-xl font-semibold py-2">Erfassung allgemeiner Informationen beim Besuch unserer Website</h2>
        ...
        <p></p><h2 class="font-basic text-xl font-semibold py-2">Cookies</h2>
        ...
        <p>Session - Ablauf nach 2 Stunden - behält die Zustände des Benutzers bei allen Seitenanfragen bei.
            <br>XSRF-Token - Ablauf nach Schließung des Browsers - Den XSRF Cookie verwenden wir zur Erhöhung der Sicherheit unserer Website. Hierbei wird ein Token im Cookie abgelegt, der das sog. Cross-Site-Request-Forgery verhindert.</p>
        <h2 class="font-basic text-xl font-semibold py-2">Technisch notwendige Cookies </h2>
        <h3>Art und Zweck der Verarbeitung: </h3>
        ...
        <p></p><h2 class="font-basic text-xl font-semibold py-2">Kontaktformular</h2>
        <h3>Art und Zweck der Verarbeitung:</h3>
        ...
        <p></p><h2 class="font-basic text-xl font-semibold py-2">Verwendung von Scriptbibliotheken (Google Webfonts)</h2>
        ...
        <p></p><h2 class="font-basic text-xl font-semibold py-2">SSL-Verschlüsselung</h2>
        <p>Um die Sicherheit Ihrer Daten bei der Übertragung zu schützen, verwenden wir dem aktuellen Stand der Technik entsprechende Verschlüsselungsverfahren (z. B. SSL) über HTTPS.</p>
        <p></p><hr>
        <h2 class="font-basic text-xl font-semibold py-2">Information über Ihr Widerspruchsrecht nach Art. 21 DSGVO</h2>
        ...
        <p>MTW-IT Solutions UG (haftungsbeschränkt)
            <br>Martin Müller
            <br>datenschutz@mtw-it.de
            <br>Am Spargelfeld 9
            <br>53797 Lohmar</p>
        <hr>
        <h2 class="font-basic text-xl font-semibold py-2">Änderung unserer Datenschutzbestimmungen</h2>
        <p>Wir behalten uns vor, diese Datenschutzerklärung anzupassen, damit sie stets den aktuellen rechtlichen Anforderungen entspricht oder um Änderungen unserer Leistungen in der Datenschutzerklärung umzusetzen, z.B. bei der Einführung neuer Services. Für Ihren erneuten Besuch gilt dann die neue Datenschutzerklärung.</p>
        <h2 class="font-basic text-xl font-semibold py-2">Fragen an den Datenschutzbeauftragten</h2>
