...
<body>
    ...
    <div id="app">
        ...
        <div class="mx-auto min-h-screen px-6 xl:px-24 2xl:px-32 bg-gray-50 h-full -mt-20 pt-20 mb-4 font-basic">
            <div class="grid grid-cols-12 gap-2">
                ...
                <div class="col-span-12 lg:col-span-6 flex justify-center items-center">
                    <img class="rounded-md" src="{{ $user_info['profile_image'] }}" alt="Profilbild">
                </div>
                ...
                <div class="hidden lg:flex flex-col col-span-6 p-2 bg-white rounded-md shadow-md justify-between">
                    ...
                    <div class="flex justify-evenly">
                        <a href="mailto:$user_info['email']" class="flex items-center">
                        ...
                        <a href="tel:{{ $user_info['telefon'] }}" class="flex items-center">
                            <span class="text-mtw-primary mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                </svg>
                ...
                <div class="lg:hidden col-span-12 p-2 bg-white rounded-md shadow-md">
                    @yield('info_text')
                </div>
                {{-- @if ($user_info['text']!='')
