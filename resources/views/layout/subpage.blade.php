    ...
    <div id="app" class="relative min-h-screen bg-gray-100 font-basic">
        ...
        <section class="bg-white  py-10">
            <div class="flex flex-col items-center justify-center ">
                <p class="text-lg text-mtw-text text-center">Profitieren Sie von unserem Know-how</p>
                <p class="text-3xl font-bold text-center pb-10">Nehmen Sie jetzt  Kontakt mit uns auf.</p>
