...
{{--    </div>--}}
    <div class="bg-gray-100">
        <div class="container mx-auto text-gray-900 py-4 px-5 flex flex-col sm:flex-row justify-between items-center">
            ...
            <div class="space-x-3">
                <a href="{{route('impressum')}}" class="font-basic text-sm text-center">Impressum</a>
                <a href="{{route('datenschutzerklärung')}}" class="font-basic text-sm text-center">Datenschutzerklärung</a>
            </div>
