<footer class="text-gray-600 font-basic bg-gray-100">
    <div class="container px-5 py-24 mx-auto hidden">
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto py-4 px-5 flex flex-col sm:flex-row justify-between items-center sm:flex-row">
            <p class="text-gray-500 font-basic text-sm text-center sm:text-left">
                © 2021 MTW IT-Solutions UG (haftungsbeschränkt)
            </p>
            <div class="space-x-3">
                <a href="{{route('impressum')}}" class="text-gray-500 font-basic text-sm text-center">Impressum</a>
                <a href="{{route('datenschutzerklärung')}}" class="text-gray-500 font-basic text-sm text-center">Datenschutzerklärung</a>
            </div>
