<template>
	<div>
		<div class="fixed top-0 w-full h-full bg-gray-200" style="z-index: 100;">
            <div class="flex justify-center">
                <img class="h-16" src="/img/logos/mtw.webp" alt="">
            </div>
			<form @submit.prevent="sendForm" action="/email" method="POST">
				...
				<div class="flex flex-wrap">
					<div class="p-2 w-full">
						<div class="relative">
							...
							<input
								...
								id="name"
								name="name"
								class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-mtw-primary focus:bg-white focus:ring-2 focus:ring-mtw-stoneblue text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
								:class="{ 'ring-red-400 ring-2': this.error.name !== '' }"
							/>
					...
					<div class="p-2 w-full">
						<div class="relative">
							...
							<input
								...
								name="email"
								class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-mtw-primary focus:bg-white focus:ring-2 focus:ring-mtw-stoneblue text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
								:class="{ 'ring-red-400 ring-2': this.error.email !== '' }"
							/>
					...
					<div class="p-2 w-full">
						<div class="relative">
							...
							<textarea
								...
								id="message"
								name="message"
								class="resize-y w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-mtw-primary focus:bg-white focus:ring-2 focus:ring-mtw-stoneblue h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
								:class="{ 'ring-red-400 ring-2': this.error.message !== '' }"
							></textarea>
					...
					<transition name="success_message">
						<div v-if="success" class="w-full rounded-xl bg-green-200 p-3 relative">
							<div class="flex justify-center items-center">
								<p class="font-basic text-lg font-medium">
									Vielen Dank.<br />
					...
					<div class="p-2 grid grid-cols-1 w-full pt-8 mt-8 border-t border-gray-200 text-center">
						...
						<p class="leading-normal my-5 font-basic">{{ this.info.adresse_straße }} <br />{{ this.info.adresse_plz }}</p>
						<!--
